...
const createStyles = (colors: PaletteType) => StyleSheet.create({
  ...
  arrowContainer: { width: 60, height: 1, backgroundColor: colors.borderLight, marginHorizontal: 10, position: 'relative' },
  arrowLine: { height: 1, width: '100%', backgroundColor: colors.borderLight },
